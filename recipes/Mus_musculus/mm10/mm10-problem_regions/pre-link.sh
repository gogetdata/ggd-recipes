...
mkdir -p $repeats
wget --quiet -O - http://files.figshare.com/1688228/LCR_mm10.bed.gz | gunzip -c | gsort /dev/stdin https://raw.githubusercontent.com/gogetdata/ggd-recipes/dev/genomes/mm10/mm10.genome | bgzip -c > $repeats/LCR.bed.gz
