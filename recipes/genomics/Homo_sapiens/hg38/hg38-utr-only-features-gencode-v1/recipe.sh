...
cat <(gzip -dc gencode.v34.chr_patch_hapl_scaff.annotation.gtf.gz | grep "^#") <(python get_utr_features.py gencode.v34.chr_patch_hapl_scaff.annotation.gtf.gz skip.txt) \
