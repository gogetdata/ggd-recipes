...
wget --quiet http://apprisws.bioinfo.cnio.es/pub/current_release/datafiles/homo_sapiens/GRCh37/appris_data.principal.txt

python get_canonical_transcripts.py Homo_sapiens.GRCh37.75.gtf.gz appris_data.principal.txt \
    | gsort /dev/stdin $genome \
    | bgzip -c > grch37-canonical-transcript-features-ensembl-v1.gtf.gz

tabix grch37-canonical-transcript-features-ensembl-v1.gtf.gz
