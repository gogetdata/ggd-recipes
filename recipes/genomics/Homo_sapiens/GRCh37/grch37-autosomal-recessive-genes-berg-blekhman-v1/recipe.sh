...
#python parse_genes.py berg_blekhman_ar.tsv  coding_gene_file.bed unflattened_ad_genes.bed  
...
EOF
python parse_gene.py berg_blekhman_ar.tsv coding_gene_file.bed unflattened_ad_genes.bed  
...
bedtools complement -i grch37-autosomal-recessive-genes-berg-blekhman-v1.bed.gz -g GRCh37.genome \
    | gsort /dev/stdin $genome \
    | sed '1d' /dev/stdin \
