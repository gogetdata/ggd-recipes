...
## bgzip 
## Tabix
gsort grch38-decomposed-normalized-clinically-associated.vcf $genome \
    | bgzip -c > grch38-clinically-associated-variants-ensembl-v1.vcf.gz

tabix grch38-clinically-associated-variants-ensembl-v1.vcf.gz
