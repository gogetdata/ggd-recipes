...
wget --quiet -O grch38-reference-genome-ensembl-v1.fa.gz ftp://ftp.ensembl.org/pub/release-95/fasta/homo_sapiens/dna/Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz
