...
# converted from: ../cloudbiolinux/ggd-recipes/hg38/coverage.yaml

mkdir -p $PREFIX/share/ggd/Homo_sapiens/hg38/hg38-coverage/ && cd $PREFIX/share/ggd/Homo_sapiens/hg38/hg38-coverage/
