...
mkdir -p $PREFIX/share/ggd/Homo_sapiens/hg38-noalt/hg38-noalt-seq/ && cd $PREFIX/share/ggd/Homo_sapiens/hg38-noalt/hg38-noalt-seq/
...
[[ -f seq/hg38-noalt.dict ]] || picard CreateSequenceDictionary REFERENCE=seq/hg38-noalt.fa OUTPUT=seq/hg38-noalt.dict SPECIES=hg38-noalt
