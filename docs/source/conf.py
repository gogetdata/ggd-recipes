# -*- coding: utf-8 -*-
#
# ggd-recipes documentation build configuration file, created by
# sphinx-quickstart.
#
...
# of the sidebar.
#html_logo = '../logo/gogetdata_temp.png'
...
html_context = {
    'extra_nav_items': {
        'ggd-recipes @ Github' : 'https://github.com/gogetdata/ggd-recipes',
        'ggd-cli @ Github' : 'https://github.com/gogetdata/ggd-cli',
    }
}
...
htmlhelp_basename = 'ggd-recipesdoc'
...
latex_documents = [
    (master_doc, 'ggd-recipes.tex', 'ggd-recipes Documentation',
     'ggd', 'manual'),
]
...
man_pages = [
    (master_doc, 'ggd-recipes', 'ggd-recipes Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ggd-recipes', 'ggd-recipes Documentation',
     author, 'ggd-recipes', 'One line description of project.',
     'Miscellaneous'),
]
